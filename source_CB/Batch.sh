#BSUB -J content
#BSUB -q hpc
#BSUB -W 60                    # Walltime limit (10 minute)
#BSUB -n 4
#BSUB -R "span[hosts=1]"
...
#time python Try.py 100 1
#time python Try.py 100 2
#time python Try.py 100 4
#time python Try.py 100 8
#time python Try.py 100 16
