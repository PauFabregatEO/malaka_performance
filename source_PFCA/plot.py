...
def plot_u(u, building_id, extra=''):
    plt.figure(figsize=(8, 6))
    plt.imshow(u[1:-1, 1:-1], cmap="hot", origin="lower")
    plt.colorbar(label="Temperature")
    plt.title(f"Temperature Distribution for Building {building_id}")
    plt.savefig("temperature_distribution_{}{}.png".format(building_id, extra), dpi=300, bbox_inches="tight")
    plt.show()
